...
export const SITE_COPY_DEFAULTS: SiteCopy = {
  ...
  footer: {
    tagline: '다원 하루설계 · TODAY · PRACTICE · GROW',
    strategy: '오늘설계',
    library: '서재',
    operations: '365 생활습관학교',
    subscribe: '이용권',
  },
  chrome: {
  ...
  pages: {
    strategy: {
      title: '실행지도',
      description: '전략 관점과 행동 루프를 한눈에 보고, 바람설계·7일 설계로 이어지는 실행신호를 확인합니다.',
    ...
    quickDesign: {
      title: '바람설계',
      description: '바람·이유·경험·강점·어려움을 단계별로 확인하고, 개인 보고서로 다음 행동을 이어갑니다.',
      kicker: 'WISH DESIGN · DETAILED CHECK',
      h2: '바람과 경험을 확인하고\n다음 설계로 이어갑니다',
      lead: '길게 쓰지 않아도 됩니다. 단계별로 남겨 두면 맞춤 보고서와 7일 설계로 연결됩니다.',
    },
    records: {
      title: '7일 설계',
    ...
    operations: {
      ...
      h2: '개인 설계 뒤에는\n운영과 사업 설계가 이어집니다',
      lead: '관리자·직장인·예비창업자·기관 담당자를 위한 도구입니다. 일반 사용자는 위의 바람설계와 7일 기록만 이용해도 됩니다.',
    },
  },
}
