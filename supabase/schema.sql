...
alter table public.day_records drop constraint if exists day_records_emotion_check;
alter table public.day_records alter column task set default '';
alter table public.day_records alter column emotion set default '';
